...
def validate_and_export(generated: np.ndarray, refolded: np.ndarray, out_cif: Path):
    ...
    to_cif_file(generated[mask_a_gen], str(out_cif / "pdl1_generated_cdr.cif"))  # chain A CDR
    to_cif_file(refolded[mask_a_ref], str(out_cif / "pdl1_refolded_cdr.cif"))    # chain A CDR
